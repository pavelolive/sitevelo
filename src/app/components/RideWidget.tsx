    ...
    <div className="w-full space-y-6">
      ...
      <div className="bg-muted/30 rounded-2xl p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-semibold text-foreground">Suivi GPS en Direct</h2>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {mockLiveData.position.location}
                  </p>
                </div>
              </div>
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-1">
                ...
                <div className="text-2xl font-bold text-foreground">{loading ? "…" : latest?.activity ? `${latest.activity.distance_km} km` : "—"} km</div>
              </div>
              
              <div className="space-y-1">
                <div className="text-sm text-muted-foreground">Vitesse</div>
                <div className="text-2xl font-bold text-foreground">{loading ? "…" : latest?.activity ? `${latest.activity.avg_speed_kmh} km/h` : "—"} km/h</div>
              </div>
              
              <div className="space-y-1">
                <div className="text-sm text-muted-foreground">Dénivelé</div>
                <div className="text-2xl font-bold text-foreground">{loading ? "…" : latest?.activity ? `${latest.activity.elevation_gain_m} m` : "—"} m</div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
                <div>
                  ...
                  <div className="text-xl font-bold text-foreground">{mockLiveData.progress.stagesCompleted} / {mockLiveData.progress.totalStages}</div>
                </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-blue-800">
                ...
                <p className="text-blue-700">
                  Ces données sont simulées à titre de démonstration. 
                  Configurez l'intégration API ou Widget pour afficher les vraies données GPS.
                </p>
              </div>
            </div>
          </Card>
